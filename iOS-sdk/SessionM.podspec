...
Pod::Spec.new do |s|
  ...
  s.source  = { :path => "SessionM_MMC_iOS_v1.15.8_Release"}
  s.authors = 'The SessionM Team'
  s.platform = :ios
  s.ios.deployment_target = '6.0'
  s.requires_arc = true
  s.source_files = "SessionM_MMC_iOS_v1.15.8_Release/SessionM-SDK/API/*.h"
  s.preserve_paths = "SessionM_MMC_iOS_v1.15.8_Release/SessionM-SDK/libSessionM.1.15.8.a"
  s.vendored_libraries = "SessionM_MMC_iOS_v1.15.8_Release/SessionM-SDK/libSessionM.1.15.8.a"
