...
#ifndef __SESSIONM__
#define __SESSIONM__
#define __SESSIONM_SDK_VERSION__ @"1.15.5"
...
/*!
 @abstract Notifies delegate that a receipt upload has finished.
 @discussion This method is called in response to a successful or failed upload when the @link uploadReceiptImage:withURL:attributes: @/link method is called.
 @param sessionM SessionM service object.
 @param error Error message received when uploading receipt image (value is <code>nil</code> for successful upload).
 */
- (void)sessionM:(SessionM *)sessionM didUploadReceiptWithErrorMessage:(NSString *)error;
/*!
 @abstract Notifies delegate that the user's lists of receipts and orders have been updated.
 @discussion This method is called when the @link receipts @/link and @link orders @/link arrays are updated.
 @param sessionM SessionM service object.
 */
- (void)sessionMDidUpdateUserActivities:(SessionM *)sessionM;
/*!
 @abstract Notifies delegate that the SessionM Mobile Marketing Cloud has acknowledged a change in an order status.
 @discussion This method is called in response to calling the @link updateStatus:withData: @/link method on an @link SMOrder @/link object.
 @param sessionM SessionM service object.
 */
...
/*!
 ...
 @abstract The result of the most recent attempt to enroll, log in, or log out a user. Note: should be accessed in sessionM:didUpdateUserRegistrationResult:errorMessages: delegate.
 */
 ...
 */
@property(nonatomic, readonly) NSArray<__kindof SMMessageData *> *messagesList;
/*!
 @property receipts
 @abstract An array of @link SMReceipt @/link objects representing receipt data that have been uploaded by the user.
 */
@property(nonatomic, readonly) NSArray<SMReceipt *> *receipts;
/*!
 @property orders
 @abstract An array of @link SMOrder @/link objects representing reward orders that have been made by the user.
 */
@property(nonatomic, readonly) NSArray<SMOrder *> *orders;
/*!
...
/*!
 @property shouldEnableUserActivities
 @abstract Determines whether @link receipts @/link and @link orders @/link will be updated by SDK. The default value is <code>NO</code>.
 */
@property(nonatomic) BOOL shouldEnableUserActivities;
/*!
...
/*!
 ...
 @discussion This method should be used by a developer to require a user to register for the SessionM rewards program. The user should already have an account for the developer's service. If the user does not already have such an account, use @link signUpUserWithData: @/link instead. Once the user is successfully registered, a verification email will be sent to the user so they can set a password for their account.
...
/*!
 ...
 @discussion The @link sessionM:didUpdateMessages: @/link delegate method is called and the @link SMSessionMDidUpdateMessagesNotification @/link notification is sent when the messages list is updated.
 @result BOOL indicating whether the SDK can make a request to update the messages list.
 */
- (BOOL)updateMessagesList;
/*!
 @abstract Updates @link receipts @/link and @link orders @/link properties.
 @discussion The @link sessionMDidUpdateUserActivities: @/link delegate method is called and the @link SMSessionMDidUpdateUserActivitiesNotification @/link notification is sent when the receipts and orders are updated.
 @result BOOL indicating whether the SDK can make a request to update the user activities.
 */
- (BOOL)updateUserActivities;
/*!
...
/*!
 ...
 @param attributes Optional meta data.
...
/*!
 @const SMSessionMDidUpdateUserActivitiesNotification
 @abstract This notification is sent when the @link receipts @/link and @link orders @/link arrays are updated.
 */
extern NSString *const SMSessionMDidUpdateUserActivitiesNotification;
/*!
 @const SMSessionMDidUpdateOrderStatusNotification
 @abstract This notification is sent when the SessionM Mobile Marketing Cloud has acknowledged a change in an order status.
 */
extern NSString *const SMSessionMDidUpdateOrderStatusNotification;
/*!
 @const SMSessionMDidUploadReceiptNotification
 @abstract This notification is sent in response to the @link uploadReceiptImage:withURL:attributes: @/link method. The notification is sent for successful and failed uploads.
 */
extern NSString *const SMSessionMDidUploadReceiptNotification;
/*!
 @const SMSessionMReceiptUploadErrorNotificationKey
 @abstract Key for accessing the <code>NSString</code> object representing the upload error message in the @link SMSessionMDidUploadReceiptNotification @/link <code>userInfo</code> dictionary.
 @discussion The <code>userInfo</code> dictionary will not contain this key if the upload was successful.
 */
extern NSString *const SMSessionMReceiptUploadErrorNotificationKey;
